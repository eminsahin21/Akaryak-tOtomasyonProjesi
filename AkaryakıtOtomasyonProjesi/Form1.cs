...
namespace AkaryakıtOtomasyonProjesi
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                F_benzin95 = F_benzin95 + (F_benzin95 * Convert.ToDouble(textBox7.Text) / 100);
            ...
            try
            {
                F_lpg = F_lpg + (F_lpg * Convert.ToDouble(textBox11.Text) / 100);
        ...
        private void txt_fiyat_yaz()
        {
            ...
            label19.Text = F_benzin97.ToString("N");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            string[] yakit_turleri = { "BENZİN(95)", "BENZİN(97)", "DİZEL", "EURODİZEL", "LPG" };
